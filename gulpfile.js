...
gulp.task('update', function () {
	...
	gulp.src('node_modules/bootstrap-treeview/dist/bootstrap-treeview.min.js').pipe(gulp.dest('js/lib'));
	...
	gulp.src('node_modules/bootstrap-treeview/dist/bootstrap-treeview.min.css').pipe(gulp.dest('css'));
